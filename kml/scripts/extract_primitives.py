...
with open("primitives_raw.txt", encoding="utf-8") as f:
    raw = f.read()
...
# Load master CSV
with open("kanji_master.csv", encoding="utf-8") as f:
...
# Save updated CSV
with open("kanji_master_updated.csv", "w", encoding="utf-8", newline="") as f:
