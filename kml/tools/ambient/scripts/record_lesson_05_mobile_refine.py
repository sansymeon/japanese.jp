...
OUTPUT = ROOT / "study_exhibitions" / "ambient_study_lesson_5.mp4"
COLLECTION = ROOT / "exhibition" / "lesson_5_study.json"
PORT = 8778
...
def main() -> int:
    ...
    url = (
        ...
        f"?collection=lesson_5_study&capture=1&typography=mobile-refine"
    )
