#!/usr/bin/env python3
"""Record Jr High Compounds Part 1 MP4 via Playwright.

Output: collections/post_elementary/post_elementary_compounds_01.mp4
"""
...
COLLECTION_ID = "post_elementary_compounds_01"
