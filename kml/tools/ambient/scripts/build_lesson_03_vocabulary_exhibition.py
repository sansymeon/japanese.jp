#!/usr/bin/env python3
"""Build Lesson 3 Vocabulary Exhibition.
...
from lesson_03_vocabulary_steps import VOCABULARY_BY_SLUG

ROOT = Path(__file__).resolve().parents[1]
REPO = ROOT.parents[1]
ASSETS = REPO / "assets"
LESSON = 3
COLLECTION_ID = "lesson_03_vocabulary"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 3 — Vocabulary Exhibition",
        "notes": (
...
def main() -> int:
    ...
    result = subprocess.run(
        [sys.executable, str(ROOT / "scripts/validate_lesson_03_vocabulary.py")],
        cwd=ROOT,
    )
