#!/usr/bin/env python3
"""Build Lessons 31–35 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_31_35_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 31–35"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_31_35_prototype",
        "title": "Japanese Reflections — Lessons 31–35 (Prototype)",
        "notes": (
