#!/usr/bin/env python3
"""Build Lessons 36–40 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_36_40_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 36–40"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_36_40_prototype",
        "title": "Japanese Reflections — Lessons 36–40 (Prototype)",
        "notes": (
