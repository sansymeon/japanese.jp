#!/usr/bin/env python3
"""Build exhibition/lesson_9_foundations.json — original order, Gallery Seal Ending."""
...
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_9_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=9,
        title="KML Ambient Foundations — Lesson 9 (Exhibition)",
        notes=(
    ...
    config["intro"]["image"] = "covers/lesson_09.jpg"
