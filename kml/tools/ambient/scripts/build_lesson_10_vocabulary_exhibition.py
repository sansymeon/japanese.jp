#!/usr/bin/env python3
"""Build Lesson 10 Vocabulary Exhibition.

Flow per exhibit: selected vocab steps → full JP verse → full EN verse.
"""
...
REPO = ROOT.parents[1]
LESSON = 10
COLLECTION_ID = "lesson_10_vocabulary"
...
def _auto_steps(
    ...
    for item in compounds_for_kanji[:4]:
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 10 — Vocabulary Exhibition",
        "notes": (
