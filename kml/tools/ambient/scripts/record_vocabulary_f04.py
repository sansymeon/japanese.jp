#!/usr/bin/env python3
"""Record Japanese Vocabulary Foundation 4 MP4 via Playwright.

Output: collections/vocabulary/vocabulary_f04.mp4
"""
...
def record(*, port: int) -> Path:
    ...
    out_path = out_dir / "vocabulary_f04.mp4"
    tmp_dir = out_dir / ".tmp_vocabulary_f04"
