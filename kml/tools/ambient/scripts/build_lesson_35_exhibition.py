#!/usr/bin/env python3
"""Build exhibition/lesson_35_foundations.json — original order, Gallery Seal Ending."""
...
REPO = ROOT.parents[1]
LESSON_HTML = REPO / "contents/books/book_01/lessons/lesson_35.html"
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_35_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=35,
        title="KML Ambient Foundations — Lesson 35 (Exhibition)",
        notes=(
            "Exhibition / presentation build. Original lesson order; "
            "Extract closes with Gallery Seal Ending. Soundtrack: Study Version 2."
        ),
        scenes=parse_scenes(html),
    )
    config["intro"]["image"] = "covers/lesson_35.png"
