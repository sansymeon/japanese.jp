#!/usr/bin/env python3
"""Build exhibition/lesson_8_foundations.json — original order, Gallery Seal Ending."""
...
REPO = ROOT.parents[1]
LESSON_HTML = REPO / "contents/books/book_01/lessons/lesson_08.html"
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_8_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=8,
        title="KML Ambient Foundations — Lesson 8 (Exhibition)",
        notes=(
            "Exhibition / presentation build. Original lesson order; "
            "Lake closes with Gallery Seal Ending. Soundtrack: Study Version 3."
        ),
        scenes=parse_scenes(html),
    )
    config["intro"]["image"] = "covers/lesson_08.png"
