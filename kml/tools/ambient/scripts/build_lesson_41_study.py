#!/usr/bin/env python3
"""Build lesson_41_study.json from lesson_41 HTML. Commence first, climax last."""
...
OUT_PATH = ROOT / "collections" / "lesson_41_study.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=41,
        title="KML Ambient Study — Lesson 41",
        scenes=scenes,
    )
