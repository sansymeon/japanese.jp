#!/usr/bin/env python3
"""Record Katakana Origins (full gojūon) MP4 via Playwright.

Output: collections/katakana_origins/katakana_origins.mp4

Uses exhibition.html?collection=katakana_origins
...
COLLECTION_ID = "katakana_origins"
...
def record(*, port: int) -> Path:
    ...
    out_dir = ROOT / "collections" / "katakana_origins"
