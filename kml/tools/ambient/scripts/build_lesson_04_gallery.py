#!/usr/bin/env python3
"""Build Lesson 4 Gallery — image and music only (final learning stage)."""
...
ASSETS = REPO / "assets"
LESSON = 4
COLLECTION_ID = "lesson_04_gallery"
...
# ~8 min Foundations bed (Lesson 4 → Study Version 1).
...
GALLERY_CAMERA_BY_SLUG: dict[str, dict] = {
    "post_a_bill": {"motion": "push-in"},
    "see": {"motion": "drift-x"},
    "newborn": {"motion": "drift-y", "focus": "50% 48%"},
    "beginning": {"motion": "rise", "focus": "50% 38%"},
    "page": {"motion": "drift-diagonal"},
    "stubborn": {"motion": "push-in"},
    "mediocre": {"motion": "drift-x"},
    "defeat": {"motion": "drift-y"},
    "ten_thousand": {"motion": "push-in", "focus": "50% 45%"},
    "phrase": {"motion": "drift-x"},
    "texture": {"motion": "push-in"},
    "ten_days": {"motion": "drift-diagonal"},
    "ladle": {"motion": "rise", "focus": "50% 42%"},
    "bulls_eye": {"motion": "push-in", "focus": "50% 40%"},
    "neck": {"motion": "drift-y"},
    "hook": {"motion": "drift-x"},
    "riot": {"motion": "push-in"},
    "straightaway": {"motion": "rise"},
    "tool": {"motion": "drift-diagonal"},
    "true": {"motion": "push-in", "focus": "50% 45%"},
}
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "KML Gallery — Lesson 4 (Foundations)",
        "notes": (
