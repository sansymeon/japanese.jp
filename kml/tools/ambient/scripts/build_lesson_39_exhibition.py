#!/usr/bin/env python3
"""Build exhibition/lesson_39_foundations.json — Friend first, Uncle last, Gallery Seal Ending."""
...
OUT_PATH = ROOT / "exhibition" / "lesson_39_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=39,
        title="KML Ambient Foundations — Lesson 39 (Exhibition)",
        notes=(
