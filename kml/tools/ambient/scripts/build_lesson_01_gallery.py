#!/usr/bin/env python3
"""Build Lesson 1 Gallery — image and music only (final learning stage)."""
...
ASSETS = REPO / "assets"
LESSON = 1
COLLECTION_ID = "lesson_01_gallery"
...
# ~8 min Foundations bed (Lesson 1 → Study Version 3).
FOUNDATIONS_SOUNDTRACK = "audio/study_version_3_minus3db.mp3"
...
GALLERY_CAMERA_BY_SLUG: dict[str, dict] = {
    "one": {"motion": "push-in"},
    "two": {"motion": "push-in", "focus": "50% 42%"},
    "three": {"motion": "drift-diagonal"},
    "four": {"motion": "push-in"},
    "five": {"motion": "drift-x"},
    "six": {"motion": "push-in"},
    "seven": {"motion": "rise"},
    "eight": {"motion": "drift-diagonal"},
    "nine": {"motion": "push-in"},
    "ten": {"motion": "drift-x"},
    "mouth": {"motion": "push-in", "focus": "50% 55%"},
    "sun": {"motion": "rise", "focus": "50% 32%"},
    "moon": {"motion": "rise", "focus": "50% 35%"},
    "field": {"motion": "drift-x"},
    "eye": {"motion": "push-in", "focus": "50% 48%"},
    "old": {"motion": "drift-diagonal"},
    "I": {"motion": "push-in"},
    "risk": {"motion": "drift-y"},
    "companion": {"motion": "drift-x"},
    "bright": {"motion": "push-in", "focus": "50% 40%"},
}
...
# Black hold before first image + soundtrack (OBS / recording lead).
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "KML Gallery — Lesson 1 (Foundations)",
        "notes": (
        ...
        "meta": {
            ...
            "lesson": LESSON,
            "stage": "gallery",
            "foundationsTrack": "study_version_3",
