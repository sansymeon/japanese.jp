#!/usr/bin/env python3
"""Build lesson_36_foundations.json from lesson_36 HTML. Strike first, Infer last."""
...
OUT_PATH = ROOT / "collections" / "lesson_36_foundations.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=36,
        title="KML Ambient Foundations — Lesson 36",
        scenes=scenes,
    )
