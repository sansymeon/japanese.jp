#!/usr/bin/env python3
"""Build exhibition/lesson_6_foundations.json — original order, Gallery Seal Ending."""
...
REPO = ROOT.parents[1]
LESSON_HTML = REPO / "contents/books/book_01/lessons/lesson_06.html"
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_6_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=6,
        title="KML Ambient Foundations — Lesson 6 (Exhibition)",
        notes=(
            "Exhibition / presentation build. Original lesson order; "
            "Resemblance closes with Gallery Seal Ending. Soundtrack: Study Version 2."
        ),
        scenes=parse_scenes(html),
    )
    config["intro"]["image"] = "covers/lesson_06.jpg"
