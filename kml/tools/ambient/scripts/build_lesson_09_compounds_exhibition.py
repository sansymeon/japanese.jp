#!/usr/bin/env python3
"""Build Lesson 9 Compounds Exhibition."""
...
REPO = ROOT.parents[1]
LESSON = 9
COLLECTION_ID = "lesson_09_compounds"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 9 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Auto-curated from kml/contents/books/book_01/compounds/lesson_09.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_09.html",
        },
        "scenes": scenes,
    }
