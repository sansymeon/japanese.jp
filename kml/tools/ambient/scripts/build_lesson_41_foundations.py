#!/usr/bin/env python3
"""Build lesson_41_foundations.json from lesson_41 HTML. Commence first, climax last."""
...
OUT_PATH = ROOT / "collections" / "lesson_41_foundations.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=41,
        title="KML Ambient Foundations — Lesson 41",
        scenes=scenes,
    )
