#!/usr/bin/env python3
"""Build Lesson 1 Vocabulary Exhibition (prototype).
...
from lesson_01_vocabulary_steps import VOCABULARY_BY_SLUG

ROOT = Path(__file__).resolve().parents[1]
REPO = ROOT.parents[1]
ASSETS = REPO / "assets"
LESSON = 1
COLLECTION_ID = "lesson_01_vocabulary"
...
from build_lesson_01_gallery import (  # noqa: E402
...
VOCABULARY_SOUNDTRACK = "audio/vocabulary_minus3db.mp3"

# Intro/outro — same as lesson_01_gallery:
#   3s black → 2s first-image fade-in → soundtrack → exhibits
#   closing gold crest hold, exhale fades with soundtrack end
# No opening crest.
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 1 — Vocabulary Exhibition (Prototype)",
        "notes": (
...
def main() -> int:
    ...
    result = subprocess.run(
        [sys.executable, str(ROOT / "scripts/validate_lesson_01_vocabulary.py")],
        cwd=ROOT,
    )
