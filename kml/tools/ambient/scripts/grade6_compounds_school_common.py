"""Grade 6 Compounds — school edition shared build helpers."""
...
SERIES_ID = "grade_6"
COLLECTION_PREFIX = "grade_6_compounds_school"
SERIES_SCOPE = "elementary_grade_6"
SERIES_TITLE = "Grade 6 Compounds"
CONTENT_TYPE = "compounds"
EDITION = "school"
GRADE = 6

# Source list: parts 1–9 × 20, part 10 × 11 (191 kanji).
PART_COUNT = 10
BOOKEND_IMAGE_COUNT = 10

SOUNDTRACK = "audio/grade_6_1_minus3db.mp3"
SOUNDTRACK_FULL = "audio/grade_6_1_minus3db.mp3"

# One dedicated bookend image per part.
_BOOKEND_IMAGE_BY_PART: dict[int, str] = {
    part: f"images/grade_6_jukugo_{part}.png" for part in range(1, PART_COUNT + 1)
}
