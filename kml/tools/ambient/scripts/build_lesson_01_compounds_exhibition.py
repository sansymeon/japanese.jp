#!/usr/bin/env python3
"""Build Lesson 1 Compounds Exhibition (prototype).

Target kanji → curated compounds from compounds/lesson_01.html on gallery artwork.
"""
...
ASSETS = REPO / "assets"
LESSON = 1
COLLECTION_ID = "lesson_01_compounds"
...
from lesson_01_compounds_curation import SELECTED_BY_SLUG  # noqa: E402
...
# Between vocabulary and gallery — dedicated bed TBD
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 1 — Compounds (Prototype)",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Curated from kml/contents/books/book_01/compounds/lesson_01.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_01.html",
        },
        "scenes": scenes,
    }
