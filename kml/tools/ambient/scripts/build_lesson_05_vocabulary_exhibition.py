#!/usr/bin/env python3
"""Build Lesson 5 Vocabulary Exhibition.
...
from lesson_05_vocabulary_steps import VOCABULARY_BY_SLUG

ROOT = Path(__file__).resolve().parents[1]
REPO = ROOT.parents[1]
ASSETS = REPO / "assets"
LESSON = 5
COLLECTION_ID = "lesson_05_vocabulary"
...
SILENT_CREST_BOOKENDS = {
    ...
    "closing": {
        ...
        "bookendSize": "small",
        # End at content + short crest — do not pad to the full vocabulary bed (~83 min).
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 5 — Vocabulary Exhibition",
        "notes": (
...
def main() -> int:
    ...
    print("  crest: short close (holdUntilSoundtrackEnds=false); no pad to bed end")
    ...
    result = subprocess.run(
        [sys.executable, str(ROOT / "scripts/validate_lesson_05_vocabulary.py")],
        cwd=ROOT,
    )
