...
OUTPUT = ROOT / "study_exhibitions" / "ambient_study_lesson_4.mp4"
COLLECTION = ROOT / "exhibition" / "lesson_4_study.json"
PORT = 8777
...
def main() -> int:
    ...
    url = (
        ...
        f"?collection=lesson_4_study&capture=1&typography=mobile-refine"
    )
