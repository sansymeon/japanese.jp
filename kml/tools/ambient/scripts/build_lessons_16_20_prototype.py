#!/usr/bin/env python3
"""Build Lessons 16–20 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_16_20_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 16–20"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_16_20_prototype",
        "title": "Japanese Reflections — Lessons 16–20 (Prototype)",
        "notes": (
            "Japanese Reflections family: image → kanji → JP verse → EN verse → crossfade. "
            "30s per exhibit; kanji is a brief reference only. "
            "Rebuilt from current lesson HTML (new study images via imageRev)."
        ),
