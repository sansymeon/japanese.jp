#!/usr/bin/env python3
"""Record Japanese Vocabulary Lesson 2 MP4 via Playwright.

Output: collections/vocabulary/vocabulary_02.mp4
"""
...
def record(*, port: int) -> Path:
    ...
    # Vocabulary ending holds through full soundtrack + silent crest; give extra margin.
    ...
    out_path = out_dir / "vocabulary_02.mp4"
    tmp_dir = out_dir / ".tmp_vocabulary_02"
