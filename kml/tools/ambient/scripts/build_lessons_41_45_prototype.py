#!/usr/bin/env python3
"""Build Lessons 41–45 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_41_45_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 41–45"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_41_45_prototype",
        "title": "Japanese Reflections — Lessons 41–45 (Prototype)",
        "notes": (
