#!/usr/bin/env python3
"""Build Lesson 3 Compounds Exhibition.

Target kanji → curated compounds from compounds/lesson_03.html on gallery artwork.
"""
...
ASSETS = REPO / "assets"
LESSON = 3
COLLECTION_ID = "lesson_03_compounds"
...
from lesson_03_compounds_curation import SELECTED_BY_SLUG  # noqa: E402
from build_lesson_03_gallery import (  # noqa: E402
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 3 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Curated from kml/contents/books/book_01/compounds/lesson_03.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_03.html",
        },
        "scenes": scenes,
    }
