#!/usr/bin/env python3
"""Build lesson_37_foundations.json from lesson_37 HTML. Original lesson order."""
...
OUT_PATH = ROOT / "collections" / "lesson_37_foundations.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=37,
        title="KML Ambient Foundations — Lesson 37",
        scenes=scenes,
    )
