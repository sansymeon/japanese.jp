#!/usr/bin/env python3
"""Record Hiragana Song まして MP4 via Playwright.

Output: collections/hiragana_song/hiragana_song_まして.mp4

Uses exhibition.html?collection=hiragana_song_まして
Soundtrack: audio/hiragana_song_まして.mp3 (~3:40) + silent crest.
"""
...
COLLECTION_ID = "hiragana_song_まして"
