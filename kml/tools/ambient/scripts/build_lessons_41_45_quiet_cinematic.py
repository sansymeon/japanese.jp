#!/usr/bin/env python3
"""Build Quiet Cinematic Japan — Lessons 41–45 exhibition.

Source: visual shortlist of lesson study images (38 stills). Holds fit
...
import quiet_cinematic_l41_45 as l41_45

ROOT = Path(__file__).resolve().parents[1]
COLLECTION_ID = l41_45.COLLECTION_ID
START, END = l41_45.START, l41_45.END
DRAFT_PATH = l41_45.DRAFT_PATH
OUT_PATH = shared.write_collection_path(ROOT, COLLECTION_ID)
SEED = l41_45.SEED


def build() -> dict:
    items = l41_45.curator_items(START, END)
    l41_45.write_draft(items)
    ...
    config["title"] = "Quiet Cinematic Japan — Lessons 41–45"
    config["notes"] = (
