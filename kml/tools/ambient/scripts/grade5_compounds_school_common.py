"""Grade 5 Compounds — school edition shared build helpers."""
...
SERIES_ID = "grade_5"
COLLECTION_PREFIX = "grade_5_compounds_school"
SERIES_SCOPE = "elementary_grade_5"
SERIES_TITLE = "Grade 5 Compounds"
CONTENT_TYPE = "compounds"
EDITION = "school"
GRADE = 5

# Source list: parts 1–9 × 20, part 10 × 13 (193 kanji).
PART_COUNT = 10
BOOKEND_IMAGE_COUNT = 10

SOUNDTRACK = "audio/grade_5_part_a_minus3db.mp3"
SOUNDTRACK_FULL = "audio/grade_5_part_a_minus3db.mp3"

# One dedicated bookend image per part.
_BOOKEND_IMAGE_BY_PART: dict[int, str] = {
    part: f"images/grade_5_jukugo_{part}.png" for part in range(1, PART_COUNT + 1)
}
