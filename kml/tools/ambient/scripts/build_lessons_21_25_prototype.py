#!/usr/bin/env python3
"""Build Lessons 21–25 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_21_25_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 21–25"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_21_25_prototype",
        "title": "Japanese Reflections — Lessons 21–25 (Prototype)",
        "notes": (
