#!/usr/bin/env python3
"""Build Grade 5 Kanji Soundtrack collections (gojūon order, mature linear edition)."""
...
from grade5_gojuon import sections_for_part  # noqa: E402
from grade5_kanji_common import (  # noqa: E402
    DEFAULT_EXHIBITION,
    MILESTONE_EVERY,
    OPENING_BOOKEND_EXHIBITION,
    PART1_OPENING_EXHIBITION,
    PART_COUNT,
    SERIES_ID,
    SERIES_SCOPE,
    SERIES_TITLE,
...
from grade5_musical_timing import (  # noqa: E402
    MS_PER_KANJI,
    fit_musical_entries,
...
def build_collection(
    ...
    *,
    ...
    config: dict = {
        ...
        "notes": (
            f"{SERIES_TITLE}: mature linear edition. "
        ...
        "display": {
            ...
            "showKanji": False,
            "showEnglish": False,
            "exhibitProfile": "grade5KanjiSoundtrack",
            "musicalTiming": True,
            "continuousFlow": True,
        },
        "meta": {
