#!/usr/bin/env python3
"""Build exhibition/lesson_10_study.json — original order, Gallery Seal Ending."""
...
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_10_study.json"
...
def build() -> dict:
    ...
    config = exhibition_study_config(
        lesson=10,
        title="KML Ambient Study — Lesson 10 (Exhibition)",
        notes=(
