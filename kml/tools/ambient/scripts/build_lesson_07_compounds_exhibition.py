#!/usr/bin/env python3
"""Build Lesson 7 Compounds Exhibition."""
...
REPO = ROOT.parents[1]
LESSON = 7
COLLECTION_ID = "lesson_07_compounds"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 7 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Auto-curated from kml/contents/books/book_01/compounds/lesson_07.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_07.html",
        },
        "scenes": scenes,
    }
