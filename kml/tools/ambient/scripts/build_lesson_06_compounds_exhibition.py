#!/usr/bin/env python3
"""Build Lesson 6 Compounds Exhibition."""
...
REPO = ROOT.parents[1]
LESSON = 6
COLLECTION_ID = "lesson_06_compounds"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 6 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Auto-curated from kml/contents/books/book_01/compounds/lesson_06.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_06.html",
        },
        "scenes": scenes,
    }
