#!/usr/bin/env python3
"""Build exhibition/lesson_7_foundations.json — original order, Gallery Seal Ending."""
...
REPO = ROOT.parents[1]
LESSON_HTML = REPO / "contents/books/book_01/lessons/lesson_07.html"
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_7_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=7,
        title="KML Ambient Foundations — Lesson 7 (Exhibition)",
        notes=(
            "Exhibition / presentation build. Original lesson order; "
            "Eternity closes with Gallery Seal Ending. Soundtrack: Study Version 1."
        ),
        scenes=parse_scenes(html),
    )
    config["intro"]["image"] = "covers/lesson_07.png"
