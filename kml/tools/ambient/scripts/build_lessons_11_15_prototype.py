#!/usr/bin/env python3
"""Build Lessons 11–15 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_11_15_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 11–15"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_11_15_prototype",
        "title": "Japanese Reflections — Lessons 11–15 (Prototype)",
        "notes": (
