#!/usr/bin/env bash
# Recording queue: finish Lessons 34–37, then the new Lessons 11–12.
#
# Safeguards (match the L33 vocabulary run):
...
LOG=collections/record_queue_l11_12_l34_37.log
PY="$(pwd)/.venv/bin/python"
if [[ ! -x "$PY" ]]; then
  PY="$(command -v python3)"
fi

# Continue 34–37 first (as requested), then the freshly built 11–12.
LESSONS=(34 35 36 37 11 12)
