#!/usr/bin/env python3
"""Record Katakana Song Typography Edition MP4 via Playwright.

Output: collections/katakana_song/katakana_song_typography.mp4

Uses exhibition.html?collection=katakana_song_typography
...
COLLECTION_ID = "katakana_song_typography"
