#!/usr/bin/env python3
"""Record Katakana Song MP4 via Playwright.

Output: collections/katakana_song/katakana_song.mp4

Uses exhibition.html?collection=katakana_song
Kana groups follow data/katakana_song_captions.sbv.
Same soundtrack as Hiragana Song (audio/kana_song.mp3).
"""
...
def record(*, port: int) -> Path:
    ...
    out_dir = ROOT / "collections" / "katakana_song"
