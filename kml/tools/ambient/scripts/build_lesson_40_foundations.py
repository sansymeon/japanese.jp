#!/usr/bin/env python3
"""Build collections/lesson_40_foundations.json — YouTube (original order, concert ending, loops)."""
...
OUT_PATH = ROOT / "collections" / "lesson_40_foundations.json"
...
def build() -> dict:
    ...
    config = youtube_foundations_config(
        lesson=40,
        title="KML Ambient Foundations — Lesson 40",
        notes=(
