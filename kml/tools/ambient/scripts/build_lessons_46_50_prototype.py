#!/usr/bin/env python3
"""Build Lessons 46–50 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_46_50_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 46–50"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_46_50_prototype",
        "title": "Japanese Reflections — Lessons 46–50 (Prototype)",
        "notes": (
