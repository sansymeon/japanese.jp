#!/usr/bin/env python3
"""Build exhibition/lesson_5_foundations.json — original order, Gallery Seal Ending."""
...
ASSETS = REPO / "assets"
OUT_PATH = ROOT / "exhibition" / "lesson_5_foundations.json"
...
def build() -> dict:
    ...
    config = exhibition_foundations_config(
        lesson=5,
        title="KML Ambient Foundations — Lesson 5 (Exhibition)",
        notes=(
    ...
    config["intro"]["image"] = "covers/lesson_05.jpg"
