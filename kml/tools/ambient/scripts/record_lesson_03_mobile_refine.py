...
OUTPUT = ROOT / "study_exhibitions" / "ambient_study_lesson_3.mp4"
COLLECTION = ROOT / "exhibition" / "lesson_3_study.json"
PORT = 8776
...
def main() -> int:
    ...
    url = (
        ...
        f"?collection=lesson_3_study&capture=1&typography=mobile-refine"
    )
