#!/usr/bin/env python3
"""Build lesson_39_foundations.json from lesson_39 HTML. Friend first, Uncle last."""
...
OUT_PATH = ROOT / "collections" / "lesson_39_foundations.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=39,
        title="KML Ambient Foundations — Lesson 39",
        scenes=scenes,
    )
