#!/usr/bin/env python3
"""Build lesson_38_foundations.json from lesson_38 HTML. Pair first, Further last."""
...
OUT_PATH = ROOT / "collections" / "lesson_38_foundations.json"
...
def build() -> dict:
    ...
    return study_config(
        lesson=38,
        title="KML Ambient Foundations — Lesson 38",
        scenes=scenes,
    )
