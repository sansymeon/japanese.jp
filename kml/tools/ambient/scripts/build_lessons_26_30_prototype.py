#!/usr/bin/env python3
"""Build Lessons 26–30 image+verse prototype exhibition collection."""
...
OUT_PATH = write_collection_path(ROOT, "lessons_26_30_prototype")
...
CLOSING_TITLE_HTML = "Ambient Kanji Gallery<br>Lessons 26–30"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": "lessons_26_30_prototype",
        "title": "Japanese Reflections — Lessons 26–30 (Prototype)",
        "notes": (
