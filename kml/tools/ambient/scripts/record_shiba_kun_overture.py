#!/usr/bin/env python3
"""Record Shiba-kun Overture MP4 via Playwright.

Output: collections/shiba_kun_overture/shiba_kun_overture.mp4

Uses exhibition.html?collection=shiba_kun_overture
Vocal captions follow data/shiba_kun_overture_captions.sbv (do not retime).
"""
...
COLLECTION_ID = "shiba_kun_overture"
...
def record(*, port: int) -> Path:
    ...
    calibrated = calibrate_soundtrack_start_ms_from_webm(
        webm, first_caption_sbv_ms=sbv0 or 17000, estimate_start_ms=estimate_ms
    )
    ...
    pad_s = max(1.0, webm_s - covered_s + 1.0)
