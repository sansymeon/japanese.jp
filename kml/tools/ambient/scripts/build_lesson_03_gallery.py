#!/usr/bin/env python3
"""Build Lesson 3 Gallery — image and music only (final learning stage)."""
...
ASSETS = REPO / "assets"
LESSON = 3
COLLECTION_ID = "lesson_03_gallery"
...
# ~8 min Foundations bed (Lesson 3 → Study Version 2).
...
GALLERY_CAMERA_BY_SLUG: dict[str, dict] = {
    "tongue": {"motion": "push-in"},
    "measuring_box": {"motion": "drift-x"},
    "rise": {"motion": "rise"},
    "round": {"motion": "push-in", "focus": "50% 45%"},
    "measurement": {"motion": "drift-diagonal"},
    "elbow": {"motion": "drift-y", "focus": "50% 52%"},
    "specialty": {"motion": "push-in"},
    "knowledgeable": {"motion": "drift-x"},
    "signal": {"motion": "push-in", "focus": "50% 42%"},
    "fortune_telling": {"motion": "drift-diagonal"},
    "up": {"motion": "rise", "focus": "50% 38%"},
    "below": {"motion": "drift-y"},
    "eminent": {"motion": "push-in"},
    "morning": {"motion": "rise", "focus": "50% 35%"},
    "derision": {"motion": "drift-x"},
    "only": {"motion": "push-in"},
    "shellfish": {"motion": "drift-diagonal"},
    "pop_song": {"motion": "push-in", "focus": "50% 48%"},
    "virtue": {"motion": "drift-x"},
    "employee": {"motion": "push-in"},
}
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "KML Gallery — Lesson 3 (Foundations)",
        "notes": (
