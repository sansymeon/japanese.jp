#!/usr/bin/env python3
"""Record Ambient Kanji Gallery — Lessons 32–40 via Playwright.

Usage:
  python scripts/record_lessons_32_40_ambient_gallery.py
  python scripts/record_lessons_32_40_ambient_gallery.py --rebuild

Output: ambient-japan-gallery-exhibitions/ambient-movies/lessons_32_40_ambient_gallery.mp4
"""
...
COLLECTION_ID = "lessons_32_40_ambient_gallery"
...
def record(*, port: int, output_dir: Path) -> Path:
    ...
    est_min = (meta.get("estimatedContentRuntimeMs") or 0) / 60000
    ...
    print(f"  Estimated content: {est_min:.1f} min")
