#!/usr/bin/env python3
"""Build Lesson 4 Compounds Exhibition.

Target kanji → curated compounds from compounds/lesson_04.html on gallery artwork.
"""
...
ASSETS = REPO / "assets"
LESSON = 4
COLLECTION_ID = "lesson_04_compounds"
...
from lesson_04_compounds_curation import SELECTED_BY_SLUG  # noqa: E402
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 4 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Curated from kml/contents/books/book_01/compounds/lesson_04.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_04.html",
        },
        "scenes": scenes,
    }
