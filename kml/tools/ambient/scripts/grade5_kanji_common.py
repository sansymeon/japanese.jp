"""Shared helpers for Grade 5 Kanji Soundtrack exhibitions."""
...
from grade5_gojuon import pigment_for_section  # noqa: E402

SERIES_ID = "grade_5"
COLLECTION_PREFIX = "grade_5"
SERIES_SCOPE = "elementary_grade_5"
SERIES_TITLE = "Grade 5 Kanji Soundtrack"
SOUNDTRACK_PARTS_1_3 = "audio/grade_5_part_a_minus3db.mp3"
SOUNDTRACK_PART_4 = "audio/grade_5_part_b_minus3db.mp3"

_SOUNDTRACK_BY_PART: dict[int, str] = {
    1: SOUNDTRACK_PARTS_1_3,
    2: SOUNDTRACK_PARTS_1_3,
    3: SOUNDTRACK_PARTS_1_3,
    4: SOUNDTRACK_PART_4,
}
...
BOOKEND_IMAGE_PART1 = "images/grade_5_part_1.png"
BOOKEND_IMAGE_PART2 = "images/grade_5_part_2.png"
BOOKEND_IMAGE_PART3 = "images/grade_5_part_3.png"
BOOKEND_IMAGE_PART4 = "images/grade_5_part_4.png"
...
# Extra lead before part 1 opening bookend (OBS / recording headroom).
...
def soundtrack_path_for_part(part: int) -> str:
    return _SOUNDTRACK_BY_PART.get(part, SOUNDTRACK_PARTS_1_3)
