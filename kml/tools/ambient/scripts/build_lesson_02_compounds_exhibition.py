#!/usr/bin/env python3
"""Build Lesson 2 Compounds Exhibition.

Target kanji → curated compounds from compounds/lesson_02.html on gallery artwork.
"""
...
ASSETS = REPO / "assets"
LESSON = 2
COLLECTION_ID = "lesson_02_compounds"
...
from lesson_02_compounds_curation import SELECTED_BY_SLUG  # noqa: E402
from build_lesson_02_gallery import (  # noqa: E402
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 2 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Curated from kml/contents/books/book_01/compounds/lesson_02.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_02.html",
        },
        "scenes": scenes,
    }
