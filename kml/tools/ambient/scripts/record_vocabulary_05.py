#!/usr/bin/env python3
"""Record Japanese Vocabulary Lesson 5 MP4 via Playwright.

Output: collections/vocabulary/vocabulary_05.mp4
"""
...
def record(*, port: int) -> Path:
    ...
    out_path = out_dir / "vocabulary_05.mp4"
    tmp_dir = out_dir / ".tmp_vocabulary_05"
