#!/usr/bin/env python3
"""Build Lesson 8 Compounds Exhibition."""
...
REPO = ROOT.parents[1]
LESSON = 8
COLLECTION_ID = "lesson_08_compounds"
...
def build() -> dict:
    ...
    return {
        ...
        "assetsBase": "../../assets",
        "id": COLLECTION_ID,
        "title": "Lesson 8 — Compounds",
        "notes": (
            "Gallery artwork per kanji: target kanji → familiar compounds with furigana. "
            "Auto-curated from kml/contents/books/book_01/compounds/lesson_08.html. "
        ...
        "meta": {
            ...
            "compoundSource": "kml/contents/books/book_01/compounds/lesson_08.html",
        },
        "scenes": scenes,
    }
