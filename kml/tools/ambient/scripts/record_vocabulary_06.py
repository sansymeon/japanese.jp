#!/usr/bin/env python3
"""Record Japanese Vocabulary Lesson 6 MP4 via Playwright.

Output: collections/vocabulary/vocabulary_06.mp4
"""
...
def record(*, port: int) -> Path:
    ...
    out_path = out_dir / "vocabulary_06.mp4"
    tmp_dir = out_dir / ".tmp_vocabulary_06"
